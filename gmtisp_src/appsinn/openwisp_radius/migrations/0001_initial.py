    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('freeradius_allowed_hosts', openwisp_utils.fields.FallbackTextField(blank=True, default='127.0.0.1,localhost', fallback='127.0.0.1,localhost', help_text='Comma separated list of IP addresses allowed to access freeradius API', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('csvfile', private_storage.fields.PrivateFileField(blank=True, help_text='The csv file containing the user details to be uploaded', null=True, storage=private_storage.storage.files.PrivateFileSystemStorage(base_url='/api/v1/radius/organization/', location='/Users/ka/Desktop/dev/pystuff/django/v0/gmt_isp/gmtisp_src/media/private'), upload_to=openwisp_radius.base.models._get_csv_file_location, verbose_name='CSV')),
