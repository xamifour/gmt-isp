    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('method', models.CharField(blank=True, choices=[('', 'Unspecified'), ('manual', 'Manually created'), ('email', 'Email (No Identity Verification)'), ('mobile_phone', 'Mobile phone verification'), ('social_login', 'Social login'), ('saml', 'Single Sign-On (SAML)')], default='', help_text='users can sign up in different ways, some methods are valid as indirect identity verification (eg: mobile phone SIM card in most countries)', max_length=64, verbose_name='registration method')),
                ('is_verified', models.BooleanField(default=False, help_text='whether the user has completed any identity verification process successfully', verbose_name='verified')),
