# Generated by Django 4.2.9 on 2024-10-26 14:28
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "amount",
                    models.DecimalField(
                        decimal_places=2, max_digits=67, verbose_name="amount"
                    ),
                ),
                (
                    "currency",
                ...
                (
                    "action",
                    models.CharField(
                        choices=[("online", "Online"), ("offline", "Back Office")],
                        default="offline",
                        max_length=67,
                        verbose_name="payment action",
                    ),
                ),
                (
                    "status",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Friendly name for user, e.g., Plan-100MB",
                        max_length=67,
                        null=True,
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        default="0.00",
                        help_text="If price is 0.00, it means free/bonus",
                        max_digits=10,
                        verbose_name="price",
                    ),
                ),
                ...
                (
                    ...
                    models.BooleanField(
                        db_index=True,
                        default=True,
                        help_text="require payment or not.",
                ...
                (
                    ...
                    models.BooleanField(
                        db_index=True,
                        default=True,
                        help_text="If true, Data purchasing now will be added to your remaining data, if you have any",
            ...
            fields=[
                ...
                (
                    ...
                    models.BigIntegerField(
                        default=0, help_text="Total data limit, eq. 10GB"
                    ),
                ),
                (
                    "uptime_limit",
                ...
                (
                    ...
                    models.DurationField(
                        blank=True,
                        help_text="00:30:00 for 30 minutes",
                        null=True,
                        verbose_name="validity (time)",
                    ),
                ),
                (
                    "validity_type",
