...
all the above models including the Order model, inherits "organization" field from this mixin
...
class AbstractUserPlan(OrgMixin, BaseMixin):
    ...
    plan = models.ForeignKey('gmtisp_billing.Plan', on_delete=models.CASCADE, 
        verbose_name=_('plan'),
        help_text=_('Friendly name for this plan, of this user'),
        )
