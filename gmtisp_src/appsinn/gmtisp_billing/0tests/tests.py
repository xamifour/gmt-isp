...
from ..plan_change import PlanChangePolicy, StandardPlanChangePolicy
from ..quota import get_user_quota
from ..taxation.eu import EUTaxationPolicy
from ..validators import ModelCountValidator
...
class TestInvoice(TestCase):
    ...
    def test_invoice_number_custom(self):
        ...
        def plans_invoice_counter_reset_function(invoice):
            from .base.models import get_initial_number
...
class CreateOrderViewTestCase(TestCase):
    ...
    def test_recalculate_order_no_connection(self):
        ...
        with no_connection():
            with patch("gmtisp_billing.taxation.eu.logger") as mock_logger:
