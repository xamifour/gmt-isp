...
FOLDER_NAME_WHERE_SETTINGS_FILE_EXISTS="gmtisp"
...
sudo cp "/home/ubuntu/mydev/$PROJECT_MAIN_DIR_NAME/nginx/nginx.conf" "/etc/nginx/sites-available/$FOLDER_NAME_WHERE_SETTINGS_FILE_EXISTS"
